...
\noindent {\sffamily{} \noindent
Appendix \ref{einstein-papers}: Excerpts from three papers by Einstein \dotfill \pageref{einstein-papers}\\
Appendix \ref{hwansappendix}: Hints and solutions                      \dotfill \pageref{hwansappendix}
}
