...
%
As remarked in example \ref{eg:force-is-lower-index} on p.~\pageref{eg:force-is-lower-index},
we wouldn't normally be interested in the upper-index force $F^a$, but raising the index
using $g^{ab}$ gives $(\nunit/\munit,\nunit/\munit,\nunit)$.
