...
\hwsolnhdr{birkhoff-hole}
(a) The argument is completely analogous. We just substitute flat spacetime into the role formerly played
by the Schwarzschild spacetime. (b) No. The field equations of general relativity aren't linear, so we
can't find the solution corresponding to a set of sources by summing over the sources.
